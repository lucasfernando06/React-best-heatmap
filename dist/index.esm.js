...
const Box = ({
  ...
  return /*#__PURE__*/React__default.createElement(Container$3, {
  ...
  }, showTooltip && visible && /*#__PURE__*/React__default.createElement("div", _extends$1({
    ref: setTooltipRef
  }, getTooltipProps({
  ...
  })), label ? /*#__PURE__*/React__default.createElement("span", null, label) : date && locale && /*#__PURE__*/React__default.createElement("span", null, format$1(date, 'PP', {
    locale
    ...
    style: {
      border: 'black',
      '--tooltipBackground': 'rgba(0, 0, 0, .75)'
    }
  }))));
};
...
const Column = ({
  ...
  return /*#__PURE__*/React__default.createElement(Container$2, rest);
};
...
const Heatmap = ({
  ...
  const getColumns = () => {
    ...
    return Array(columnsCount).fill(0).map((_, index) => {
      ...
      const month = days.every(x => format$1(x.date, 'M') === format$1(days[0].date, 'M')) ? format$1(days[0].date, 'MMM', {
        finalLocale
      }) : '';
      const year = format$1(refDate, 'y');
      return {
        index,
        month,
        year,
  ...
  return /*#__PURE__*/React__default.createElement(Container$1, null, /*#__PURE__*/React__default.createElement(FlexContainer, null, /*#__PURE__*/React__default.createElement(WeekContainer, null, Array(7).fill(0).map((_, index) => /*#__PURE__*/React__default.createElement(WeekLabel, {
    style: {
      visibility: showWeekDays.includes(index) ? 'visible' : 'hidden'
    }
  }, finalLocale.localize.day(index, {
    width: 'short'
  })))), /*#__PURE__*/React__default.createElement(ColumnsContainer, null, columns && columns.map(column => {
    const {
      index,
      month,
      year,
    ...
    return /*#__PURE__*/React__default.createElement(Column, column, /*#__PURE__*/React__default.createElement("span", {
      style: {
        left: index * 14,
        visibility: showMonths && showMonth(index, month, year) ? 'visible' : 'hidden'
      }
    }, month), /*#__PURE__*/React__default.createElement(BoxContainer, null, days && days.map((day, indexDay) => {
      const startDay = getStartDay();
  ...
  }))), /*#__PURE__*/React__default.createElement(FlexContainer, {
    legend: true
  }, contentBeforeLegend && /*#__PURE__*/React__default.createElement("span", {
    style: {
      marginRight: 5
    }
  }, contentBeforeLegend), legend && legend.map(legend => /*#__PURE__*/React__default.createElement(Box, {
    box: { ...legend,
      value: legend.label
    },
    showTooltip: showLegendTooltip,
    boxShape: boxShape
  })), contentAfterLegend && /*#__PURE__*/React__default.createElement("span", {
    style: {
      marginLeft: 5
    }
  }, contentAfterLegend)));
...
const Container = (props = {}) => {
  ...
  return /*#__PURE__*/React__default.createElement(ThemeProvider, {
    theme: {}
  }, /*#__PURE__*/React__default.createElement(Heatmap, options));
};
